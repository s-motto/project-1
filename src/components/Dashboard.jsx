...
const Dashboard = ({ onClose }) => {
  ...
  const handleExportGpx = (route) => {
    ...
    const dateStr = formatTimestampForFilename(
  ...
  const handleExportImage = async (route) => {
    ...
    const blob = await trackToPng(name, points, {
      width: 1600,
      height: 1000,
      basemapKey,
      staticTileUrl,
        ...
        <div className="modal-content max-w-md">
          ...
          <div className="modal-body text-center">
            <p style={{ color: "var(--text-secondary)" }}>
              Effettua il login per vedere le tue statistiche
            </p>
          </div>
        </div>
      </div>
          ...
          {loading ? (
            ...
            <>
                ...
                <div className="dashboard-stats-grid">
                  ...
                  <StatsCard
                    ...
                    value={
                      settings?.distanceUnit === "mi"
                        ? (() => {
                            const mi = stats.totalKm * KM_TO_MI;
                            return mi >= 1000
                              ? `${(mi / 1000).toFixed(1)}k mi`
                              : `${mi.toFixed(1)} mi`;
                          })()
              ...
              <div className="dashboard-chart-section">
                <h3 className="dashboard-section-title">
                  📈 {settings?.distanceUnit === "mi" ? "Mi" : "Km"} percorsi
                  per mese
                </h3>
                  ...
                  <ResponsiveContainer width="100%" height={250}>
                    ...
                    >
                      ...
                      <YAxis
                        ...
                        style={{ fontSize: "12px" }}
                        label={{
                          value: settings?.distanceUnit === "mi" ? "mi" : "km",
                          angle: -90,
                          position: "insideLeft",
                        }}
                      />
              ...
              <div className="mt-6">
                <h3 className="dashboard-section-title">
                  📤 Esporta GPX dei percorsi completati
                </h3>
                    ...
                    >
                      ...
                      <div className="flex items-center gap-1.5 flex-wrap justify-end">
                        <button
                          ...
                          disabled={
                            !(
                              Array.isArray(r.actualCoordinates) &&
                              r.actualCoordinates.length > 1
                            ) &&
                            !(
                          ...
                          title={
                            ...
                            r.actualCoordinates.length > 1
                              ? "Esporta traccia GPX"
                              : "Esporta GPX del percorso pianificato"
                          }
                        >
                          GPX
                        </button>
              ...
              <div className="dashboard-footer">
                <p
                  ...
                  style={{ color: "var(--text-secondary)" }}
                >
                  💡 Le statistiche sono calcolate dai percorsi che hai
                  completato
                </p>
              </div>
            </>
