...
const Achievements = ({ onClose, stats }) => {
  ...
  const getProgressToNextLevel = () => {
    if (!currentLevelInfo || !stats)
      return { percentage: 0, current: 0, target: 0 };

    const currentKm = stats.totalKm;
    const nextLevel = achievementsService.getLevelInfo(
      achievements.currentLevel + 1,
    );
  ...
  const completedChallengesCount = dailyChallenges.filter(
    (c) => c.completed,
  ).length;
            ...
            <div className="space-y-6">
                    ...
                    >
                      <div
                        ...
                        style={{
                          ...
                          background:
                            "linear-gradient(90deg, #A9CBB7, #5A8370)",
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  ...
                  <FaFire
                    className="text-2xl"
                    style={{ color: isStreakActive ? "#FFE66D" : "#ccc" }}
                  />
                </div>
              ...
              {dailyChallenges.length > 0 && (
                ...
                >
                        ...
                        {challenge.completed && (
                          <div className="flex-shrink-0">
                            <div
                              ...
                              style={{
                                backgroundColor: allChallengesCompleted
                  ...
                  {allChallengesCompleted && (
                    <div
                      className="text-xs mt-4 pt-3 border-t border-white/20 text-center font-bold"
                      style={{ color: "#FFE66D" }}
                    >
